...
public class getponits extends AppCompatActivity {
    LinearLayout l,l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter aa=new ArrayAdapter(getponits.this,R.layout.support_simple_spinner_dropdown_item,time);
        ...
        ArrayAdapter aa2=new ArrayAdapter(getponits.this,R.layout.support_simple_spinner_dropdown_item,week);
        ...
        subscribe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getponits.this, "Total payable is "+i+"Proceed to Pay", Toast.LENGTH_SHORT).show();
